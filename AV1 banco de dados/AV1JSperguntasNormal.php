...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $resposta_json = json_encode($inputData['respostas'], JSON_UNESCAPED_UNICODE);
    $data_atual = date('Y-m-d H:i:s');
    
    $stmt = $pdo->prepare("INSERT INTO respostas_questionario (email_usuario, data, respostas) VALUES (?, ?, ?)");
    $stmt->execute([$_SESSION['email'], $data_atual, $resposta_json]);
